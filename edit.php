                    ...
                    <div class="form-row">
                        ...
                        <div class="col">
                            ...
                            <select name="division" id="division" class="form-control">
                                ...
                                if($division == "dhaka"){echo 'selected';}
                                ?>>Dhaka</option>

                                <option value="rangpur" <?php 
                                if($division == "rangpur"){echo 'selected';}
                                ?>>Rangpur</option>
                                
                                <option value="rajshahi" <?php 
                                if($division == "rajshahi"){echo 'selected';}
                                ?> >Rajshahi</option>
                                 <option value="sylet" <?php 
                                if($division == "sylet"){echo 'selected';}
                                ?> >Sylet</option>
                            </select>
                        </div>
                    </div>
